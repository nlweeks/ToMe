...
extension TodoItem {
    ...
    static func randomTodo() -> TodoItem {
        ...
        return TodoItem(
            ...
            todoDescription: descriptions.randomElement() ?? "Task description",
